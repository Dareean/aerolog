    ...
    <nav class="fixed top-0 w-full z-50 bg-canvas border-b border-surface-container-high flat no shadows">
        <div class="max-w-[1200px] mx-auto flex justify-between items-center h-16 px-lg">
            ...
            <div class="hidden md:flex gap-lg">
                <a class="text-primary font-bold border-b-2 border-primary pb-1 cursor-pointer" href="/">Home</a>
                <a class="text-on-surface-variant hover:text-primary transition cursor-pointer" href="#about">About</a>
                <a class="text-on-surface-variant hover:text-primary transition cursor-pointer" href="#testimonials">Testimonials</a>
            </div>
            <div class="flex items-center gap-md">
                @auth
                    <a href="{{ route('dashboard') }}" class="bg-primary text-on-primary h-[40px] px-lg rounded-lg font-button-label text-button-label hover:bg-surface-dark transition-colors inline-flex items-center justify-center">Dashboard</a>
                @else
                    <a href="{{ route('login') }}" class="text-on-surface-variant hover:text-primary transition-colors font-button-label">Log in</a>
                    <a href="{{ route('register') }}" class="bg-primary text-on-primary h-[40px] px-lg rounded-lg font-button-label text-button-label hover:bg-surface-dark transition-colors inline-flex items-center justify-center">Sign Up</a>
                @endauth
            </div>
        </div>
    </nav>
        ...
        <main class="flex-grow w-full max-w-[1200px] mx-auto px-lg">
            ...
            <section class="block pb-section">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-lg mt-section">
                    <div class="bg-canvas border border-surface-strong rounded-xl p-lg shadow-sm">
                        ...
                        <p class="font-body-sm text-body-sm text-on-surface-variant">Machine learning models calculate the most fuel-efficient trajectories in real-time, reducing operational costs.</p>
                    </div>
                    <div class="bg-canvas border border-surface-strong rounded-xl p-lg shadow-sm">
                        ...
                        <p class="font-body-sm text-body-sm text-on-surface-variant">Continuous monitoring of flight hours and layover periods ensures compliance with regulatory rest requirements.</p>
                    </div>
                    <div class="bg-canvas border border-surface-strong rounded-xl p-lg shadow-sm">
                        ...
                        <p class="font-body-sm text-body-sm text-on-surface-variant">Sync direct block times, fuel burns, and landing rates to dispatch instantly upon engine shutdown.</p>
                    </div>
                </div>
            </section>
            ...
            <section id="about" class="pb-section pt-xl">
                <div class="text-center mb-xl">
                    <h2 class="font-display-xl text-display-xl text-primary mb-md">Background & Goals</h2>
                    <p class="font-body-md text-body-md text-on-surface-variant max-w-2xl mx-auto">
                        Placeholder text for AeroLog background. AeroLog was created to modernize flight operations, combining predictive AI with intuitive interfaces for pilots and dispatchers.
                    </p>
                </div>
            ...
            <section id="testimonials" class="pb-section">
                <div class="text-center mb-xl">
                    <h2 class="font-display-xl text-display-xl text-primary mb-md">Trusted by Professionals</h2>
                    <p class="font-body-md text-body-md text-on-surface-variant max-w-2xl mx-auto">
                        Placeholder text for testimonials. See what leading pilots and dispatchers say about AeroLog.
                    </p>
                </div>
            ...
            <div class="mb-section bg-surface-bright border border-surface-strong rounded-xl p-xxl text-center">
                ...
                @auth
                    <a href="{{ route('dashboard') }}" class="bg-primary text-on-primary h-[40px] px-xl rounded-lg font-button-label text-button-label hover:bg-surface-dark transition-colors inline-flex items-center justify-center">Go to Dashboard</a>
                @else
                    <a href="{{ route('register') }}" class="bg-primary text-on-primary h-[40px] px-xl rounded-lg font-button-label text-button-label hover:bg-surface-dark transition-colors inline-flex items-center justify-center">Create Account</a>
                @endauth
            </div>
        </main>
    </div>
