            ...
            <main class="max-w-6xl mx-auto px-6 -mt-12">
                ...
                <section class="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
                    ...
                    <div class="rounded-xl border border-[#f0f0f3] bg-white p-6">
                        ...
                        <div class="mt-3">
                            <span class="inline-flex rounded-full bg-[#fff7dd] px-3 py-1 text-xs font-semibold tracking-wide text-[#ab6400]">REST REQUIRED</span>
                        </div>
                    </div>
                </section>
                ...
                <section class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                            ...
                            <table class="min-w-full divide-y divide-[#f0f0f3]">
                                ...
                                <tbody class="divide-y divide-[#f5f5f7]">
                                    <tr>
                                        ...
                                        <td class="px-4 py-3 text-sm"><span class="inline-flex rounded-full bg-[#ecfdf3] px-3 py-1 text-xs font-semibold uppercase tracking-wide text-[#16a34a]">Stable</span></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="px-4 py-3 text-sm"><span class="inline-flex rounded-full bg-[#fff7dd] px-3 py-1 text-xs font-semibold uppercase tracking-wide text-[#ab6400]">Review</span></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <aside class="rounded-xl border border-[#cfe7ff] bg-[#ffffff] p-6">
                        ...
                        <p class="text-base font-normal leading-6 text-[#60646c]">Penerbangan WAAA-WIII pada 35.000 ft kurang efisien. Pengurangan ketinggian ke 33.000 ft dapat menghemat 150 kg bahan bakar.</p>
                    </aside>
                </section>
            </main>
